...
//                Log.d("cnt", "icnt" + count);
        ...
        Log.d("cmt", "appcnt= " +mAppName +"="+ appLaunchCount);
        count=count/7;
...
//                        for(int i=0; i<appFilteredEvents.appEvents.size(); i++){
//                            Log.d("app", "i="+ appFilteredEvents.appEvents.get(i).date);
//                        }
...
//    private String targetPackageName = mAppName;
